...
DEFAULT_RKNN_PATH = 'dpt_swin2_tiny_256.rknn'
DEFAULT_QUANT = True
...
if __name__ == "__main__":
    ...
    # Pre-process config
    print('--> Config model')
    # MiDaS dpt_swin2_tiny_256 preprocessing is typically:
    #   img_uint8 -> img/255 -> (img/255 - 0.5)/0.5
    # Equivalent when feeding uint8 [0..255] into RKNN preprocess:
    #   (img - 127.5) / 127.5
    ret = rknn.config(
